...
namespace Content.Client._Stories.Explosion;

public sealed partial class ExplosionShockWaveOverlay : Overlay
{
    [Dependency] private IEntityManager _entMan = default!;
    [Dependency] private IPrototypeManager _prototypeManager = default!;

    private static readonly ProtoId<ShaderPrototype> ShockWaveShader = "STExplosionShockWave";
    ...
    protected override bool BeforeDraw(in OverlayDrawArgs args)
    {
        ...
        var query = _entMan.EntityQueryEnumerator<StoriesExplosionShockWaveComponent, TransformComponent>();
