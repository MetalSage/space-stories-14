...
public sealed partial class TtsAudioProcessingSystem : EntitySystem
{
    ...
    private string _announceFfmpegFilter = "";
    private bool _radioEffectEnabled;
    private bool _announceEffectEnabled;
    ...
    public override void Initialize()
    {
        ...
        _cfg.OnValueChanged(SCCVars.TTSAnnounceEffect, v =>
        {
            _announceEffectEnabled = v;
            if (v)
                EnableEffect(TTSAudioEffect.Announce);
        }, true);
        ...
        _cfg.OnValueChanged(SCCVars.TTSAnnounceFfmpegFilter, v =>
        {
            _announceFfmpegFilter = v;
            EnableEffect(TTSAudioEffect.Announce);
        }, true);
    }
    ...
    {
        effects = NormalizeEffects(effects, _radioEffectEnabled, _announceEffectEnabled);
    ...
    internal static TTSAudioEffect NormalizeEffects(TTSAudioEffect effects, bool radioEffectEnabled, bool announceEffectEnabled)
    {
        ...
        if (!announceEffectEnabled)
            effects &= ~TTSAudioEffect.Announce;
    ...
    private string GetEffectFilter(TTSAudioEffect effect)
    {
        return effect switch
        {
            ...
            TTSAudioEffect.Announce => _announceFfmpegFilter,
            _ => "",
        };
    }
    ...
    private static string GetEffectName(TTSAudioEffect effect)
    {
        return effect switch
        {
            ...
            TTSAudioEffect.Announce => "announce",
            _ => effect.ToString(),
        };
    }
