...
public sealed partial class ForensicsSystem : EntitySystem
{
    ...
    [SubscribeLocalEvent]
    private void OnInteract(Entity<FingerprintComponent> ent, ref ContactInteractionEvent args) // Stories-Pontific: По логике, ничего не должно сломаться после замены HandsComponent, ведь метод обращается к FingerprintComponent
    {
