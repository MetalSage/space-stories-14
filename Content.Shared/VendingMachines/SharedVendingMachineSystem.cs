...
public abstract partial class SharedVendingMachineSystem : EntitySystem
{
        ...
        VendingMachineComponent? component = null, float restockQuality = 1f)
    {
        ...
        AddInventoryFromPrototype(uid, packPrototype.StartingInventory, InventoryType.Regular, component, restockQuality, packPrototype.ItemPrices);
        AddInventoryFromPrototype(uid, packPrototype.EmaggedInventory, InventoryType.Emagged, component, restockQuality, packPrototype.ItemPrices);
        AddInventoryFromPrototype(uid, packPrototype.ContrabandInventory, InventoryType.Contraband, component, restockQuality, packPrototype.ItemPrices);
        Dirty(uid, component);
    }
    ...
    private void AddInventoryFromPrototype(EntityUid uid, Dictionary<EntProtoId, uint>? entries,
        ...
        Dictionary<EntProtoId, uint>? prices = null)
    {
        ...
        foreach (var (id, amount) in entries)
        {
            ...
            var price = prices?.GetValueOrDefault(id) ?? 0;
