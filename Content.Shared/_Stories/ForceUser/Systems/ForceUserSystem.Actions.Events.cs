...
public sealed partial class FlashAreaEvent : InstantActionEvent
{
    ...
    [DataField("slowTo"), ViewVariables(VVAccess.ReadWrite)]
...
{
    [ViewVariables(VVAccess.ReadWrite), DataField("stackAmount")]
...
{
    [DataField("proto")]
    public EntProtoId Proto = "STEffectProtectiveBubble";
}
...
public sealed partial class InquisitorPolymorphEvent : InstantActionEvent
{
    ...
    [DataField("prototype")]
    public ProtoId<PolymorphPrototype> PolymorphPrototype { get; set; } = "STInquisitorGhost";
}
