...
Space Stories — это многопользовательская игра о жизни на космической станции, ремейк культовой [Space Station 13](https://spacestation13.com/), работающий на движке [Robust Toolbox](https://github.com/space-wizards/RobustToolbox). Проект основан на [Space Station 14](https://github.com/space-wizards/space-station-14).

Это основной репозиторий русскоязычного проекта Space Stories. Чтобы пользователям не приходилось делать форки Robust Toolbox, клиент и сервер загружают "контент-пак". Этот пакет содержит всё необходимое для игры на конкретном сервере.

## Ссылки

[Вики](https://spacestories.club/) | [Discord](https://discord.gg/space-stories) | [Лаунчер SS14 в Steam](https://store.steampowered.com/app/1255460/Space_Station_14/) | [Скачать отдельный лаунчер](https://spacestation14.io/about/nightlies/)
...
Код и наработки проекта Space Stories представляют собой смешанную интеллектуальную собственность. Наш уникальный контент защищен проприетарной лицензией, а сторонние компоненты сохраняют свои свободные лицензии.

### Почему мы используем проприетарную лицензию?
Наш проект — это результат огромного труда команды, и мы хотим сохранить уникальность Space Stories. Наша лицензия призвана защитить проект от копирования и сохранить наши уникальные особенности как визитную карточку сервера.
...
Отправляя свой код или ассеты (создавая Pull Request), вы передаете администрации проекта безотзывную, бесплатную и бессрочную лицензию на их использование, модификацию и распространение как в рамках Space Stories, так и в любых наших текущих и будущих проектах. Ваше авторство на оригинальную работу при этом сохраняется, вы можете продолжать использовать свой личный код в своих целях, но вы не сможете потребовать удалить ваш вклад из нашего репозитория в будущем.

Полный текст нашей лицензии: [LICENSE.TXT](/LICENSE.TXT)

### Сторонний код и ассеты:
Мы уважаем open-source сообщество. Весь код, оригинально взятый из репозитория `space-wizards/space-station-14`, сохраняет свою лицензию **MIT**. Вы можете свободно извлекать и использовать эти части в соответствии с их лицензией.
...
Обратите внимание, в проекте действует презумпция авторского права. Если в метафайле конкретного ассета или файла кода прямо не указана свободная лицензия, по умолчанию он считается проприетарной собственностью проекта Space Stories и защищен запретами, описанными выше. Любой желающий извлечь контент по свободной лицензии обязан самостоятельно убедиться в его происхождении.
