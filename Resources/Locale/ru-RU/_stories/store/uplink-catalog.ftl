...
uplink-afterburner-implanter-name = Имплантер "Форсаж"
uplink-afterburner-implanter-desc = При активации вводит в тело дозу стимуляторов. Имеет встроенный синтезатор химикатов и может быть использован неограниченное количество раз.
