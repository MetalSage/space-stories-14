...
stories-uplink-rapier-name = Рапира Синдиката
stories-uplink-rapier-desc = Элегантно выполненная из пластитана рапира, заточённая особым методом. Крайне остра и способна пробивать большинство видов брони.
