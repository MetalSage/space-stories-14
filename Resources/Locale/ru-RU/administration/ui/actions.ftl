...
admin-player-actions-respawn-message = Вернуть игрока в лобби, позволив ему возродиться в новом персонаже по желанию.
admin-player-actions-spawn = Заспавнить тут
admin-player-actions-spawn-message = Создаёт копию персонажа и тут же переносит его сознание в неё.
...
admin-player-actions-clone-message = Создаёт копию персонажа, не перенося его сознание в неё.
admin-player-actions-follow = Следовать
admin-player-actions-check-afk = Пометить как AFK
