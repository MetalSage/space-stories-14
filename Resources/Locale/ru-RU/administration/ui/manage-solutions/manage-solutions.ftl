...
admin-solutions-window-solution-button-tooltip = Открывает соответствующую серверную сущность Solution в ViewVariables. Полезно для отладки проблем с предсказанием.
