...
health-examinable-carbon-Slash-8 = [color=yellow]У { CONJUGATE-BE($target) } неглубокий порез.[/color]
health-examinable-carbon-Slash-15 = [color=yellow]У { CONJUGATE-BE($target) } несколько маленьких порезов.[/color]
health-examinable-carbon-Slash-30 = [color=orange]У { CONJUGATE-BE($target) } несколько значительных порезов.[/color]
...
health-examinable-carbon-Blunt-8 = [color=yellow]У { CONJUGATE-BE($target) } лёгкий ушиб.[/color]
health-examinable-carbon-Blunt-15 = [color=yellow]У { CONJUGATE-BE($target) } несколько ушибов.[/color]
...
health-examinable-carbon-Piercing-8 = [color=yellow]У { CONJUGATE-BE($target) } небольшая колотая рана.[/color]
health-examinable-carbon-Piercing-15 = [color=yellow]У { CONJUGATE-BE($target) } несколько колотых ран.[/color]
health-examinable-carbon-Piercing-30 = [color=orange]У { CONJUGATE-BE($target) } множественные глубокие колотые раны.[/color]
...
health-examinable-carbon-Heat-8 = [color=orange]У { CONJUGATE-BE($target) } поверхностный ожог.[/color]
health-examinable-carbon-Heat-15 = [color=orange]У { CONJUGATE-BE($target) } несколько ожогов первой степени.[/color]
health-examinable-carbon-Heat-30 = [color=orange]У { CONJUGATE-BE($target) } несколько ожогов второй степени.[/color]
