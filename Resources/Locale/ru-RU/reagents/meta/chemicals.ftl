...
reagent-name-artifact-glue = клей артефакта
reagent-desc-artifact-glue = Смесь клея и артефексия. Может восстанавливать прочность узлов артефакта при контакте.
