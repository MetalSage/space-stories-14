...
ent-ClothingShoesBootsJump = прыгательные ботинки
    .desc = Высокотехнологичные ботинки, которые дают вам невероятную способность ПРЫГАТЬ! С этими ботинками вы можете перепрыгивать через лаву, пропасти и странные химикаты на полу!
