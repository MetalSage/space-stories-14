...
ent-ChameleonProjectorNoBattery = маскировочный проектор
    .desc = Технология голопаразитов используется для создания копии любого окружающего вас объекта в твердом свете. Маскировка разрушается при поднятии или деактивации.
