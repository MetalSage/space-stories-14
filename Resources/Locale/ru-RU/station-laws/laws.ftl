...
laws-notify = Вы обязаны соблюдать законы синтетиков, увидеть которые можно через панель действий. Вы должны [color=red]всегда[/color] следовать своим законам.
